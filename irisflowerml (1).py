...
Original file is located at
    https://colab.research.google.com/gist/kineretlevi/3fb87448970f99e3381535fd8a896233/irisflowerml.ipynb
"""
...
# Fitting the model using .fit() and predicting using .predict()
model = SVC(gamma='auto')
model.fit(X_train, y_train)
prediction = model.predict(X_test)

# Checking the accuracy of our model and printing report.
